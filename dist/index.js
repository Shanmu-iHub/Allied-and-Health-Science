var vt=Object.defineProperty;var Fe=e=>{throw TypeError(e)};var yt=(e,t,s)=>t in e?vt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var p=(e,t,s)=>yt(e,typeof t!="symbol"?t+"":t,s),Ne=(e,t,s)=>t.has(e)||Fe("Cannot "+s);var o=(e,t,s)=>(Ne(e,t,"read from private field"),s?s.call(e):t.get(e)),m=(e,t,s)=>t.has(e)?Fe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),h=(e,t,s,a)=>(Ne(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),u=(e,t,s)=>(Ne(e,t,"access private method"),s);var We=(e,t,s,a)=>({set _(r){h(e,t,r,s)},get _(){return o(e,t,a)}});var qe=(e,t,s)=>(a,r)=>{let i=-1;return l(0);async function l(c){if(c<=i)throw new Error("next() called multiple times");i=c;let n,d=!1,g;if(e[c]?(g=e[c][0][0],a.req.routeIndex=c):g=c===e.length&&r||void 0,g)try{n=await g(a,()=>l(c+1))}catch(x){if(x instanceof Error&&t)a.error=x,n=await t(x,a),d=!0;else throw x}else a.finalized===!1&&s&&(n=await s(a));return n&&(a.finalized===!1||d)&&(a.res=n),a}},wt=Symbol(),kt=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,i=(e instanceof rt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?St(e,{all:s,dot:a}):{}};async function St(e,t){const s=await e.formData();return s?Ct(s,t):{}}function Ct(e,t){const s=Object.create(null);return e.forEach((a,r)=>{t.all||r.endsWith("[]")?At(s,r,a):s[r]=a}),t.dot&&Object.entries(s).forEach(([a,r])=>{a.includes(".")&&(_t(s,a,r),delete s[a])}),s}var At=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},_t=(e,t,s)=>{let a=e;const r=t.split(".");r.forEach((i,l)=>{l===r.length-1?a[i]=s:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},Xe=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},jt=e=>{const{groups:t,path:s}=Tt(e),a=Xe(s);return Dt(a,t)},Tt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const r=`@${a}`;return t.push([r,s]),r}),{groups:t,path:e}},Dt=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let r=e.length-1;r>=0;r--)if(e[r].includes(a)){e[r]=e[r].replace(a,t[s][1]);break}}return e},je={},Mt=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return je[a]||(s[2]?je[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:je[a]=[e,s[1],!0]),je[a]}return null},Be=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},It=e=>Be(e,decodeURI),et=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const r=t.charCodeAt(a);if(r===37){const i=t.indexOf("?",a),l=t.slice(s,i===-1?void 0:i);return It(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63)break}return t.slice(s,a)},Et=e=>{const t=et(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ie=(e,t,...s)=>(s.length&&(t=ie(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),tt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))a+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){s.length===0&&a===""?s.push("/"):s.push(a);const i=r.replace("?","");a+="/"+i,s.push(a)}else a+="/"+r}),s.filter((r,i,l)=>l.indexOf(r)===i)},ze=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Be(e,at):e):e,st=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let l=e.indexOf("?",8);if(l===-1)return;for(e.startsWith(t,l+1)||(l=e.indexOf(`&${t}`,l+1));l!==-1;){const c=e.charCodeAt(l+t.length+1);if(c===61){const n=l+t.length+2,d=e.indexOf("&",n);return ze(e.slice(n,d===-1?void 0:d))}else if(c==38||isNaN(c))return"";l=e.indexOf(`&${t}`,l+1)}if(a=/[%+]/.test(e),!a)return}const r={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const l=e.indexOf("&",i+1);let c=e.indexOf("=",i);c>l&&l!==-1&&(c=-1);let n=e.slice(i+1,c===-1?l===-1?void 0:l:c);if(a&&(n=ze(n)),i=l,n==="")continue;let d;c===-1?d="":(d=e.slice(c+1,l===-1?void 0:l),a&&(d=ze(d))),s?(r[n]&&Array.isArray(r[n])||(r[n]=[]),r[n].push(d)):r[n]??(r[n]=d)}return t?r[t]:r},Pt=st,Rt=(e,t)=>st(e,t,!0),at=decodeURIComponent,Ue=e=>Be(e,at),ne,M,O,it,ot,Le,U,Ve,rt=(Ve=class{constructor(e,t="/",s=[[]]){m(this,O);p(this,"raw");m(this,ne);m(this,M);p(this,"routeIndex",0);p(this,"path");p(this,"bodyCache",{});m(this,U,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const r=Object.keys(t)[0];return r?t[r].then(i=>(r==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,h(this,M,s),h(this,ne,{})}param(e){return e?u(this,O,it).call(this,e):u(this,O,ot).call(this)}query(e){return Pt(this.url,e)}queries(e){return Rt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await kt(this,e))}json(){return o(this,U).call(this,"text").then(e=>JSON.parse(e))}text(){return o(this,U).call(this,"text")}arrayBuffer(){return o(this,U).call(this,"arrayBuffer")}blob(){return o(this,U).call(this,"blob")}formData(){return o(this,U).call(this,"formData")}addValidatedData(e,t){o(this,ne)[e]=t}valid(e){return o(this,ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[wt](){return o(this,M)}get matchedRoutes(){return o(this,M)[0].map(([[,e]])=>e)}get routePath(){return o(this,M)[0].map(([[,e]])=>e)[this.routeIndex].path}},ne=new WeakMap,M=new WeakMap,O=new WeakSet,it=function(e){const t=o(this,M)[0][this.routeIndex][1][e],s=u(this,O,Le).call(this,t);return s&&/\%/.test(s)?Ue(s):s},ot=function(){const e={},t=Object.keys(o(this,M)[0][this.routeIndex][1]);for(const s of t){const a=u(this,O,Le).call(this,o(this,M)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?Ue(a):a)}return e},Le=function(e){return o(this,M)[1]?o(this,M)[1][e]:e},U=new WeakMap,Ve),Nt={Stringify:1},lt=async(e,t,s,a,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(r?r[0]+=e:r=[e],Promise.all(i.map(c=>c({phase:t,buffer:r,context:a}))).then(c=>Promise.all(c.filter(Boolean).map(n=>lt(n,t,!1,a,r))).then(()=>r[0]))):Promise.resolve(e)},zt="text/plain; charset=UTF-8",He=(e,t)=>({"Content-Type":e,...t}),ve,ye,z,de,H,T,we,ce,ge,J,ke,Se,G,oe,$e,Ht=($e=class{constructor(e,t){m(this,G);m(this,ve);m(this,ye);p(this,"env",{});m(this,z);p(this,"finalized",!1);p(this,"error");m(this,de);m(this,H);m(this,T);m(this,we);m(this,ce);m(this,ge);m(this,J);m(this,ke);m(this,Se);p(this,"render",(...e)=>(o(this,ce)??h(this,ce,t=>this.html(t)),o(this,ce).call(this,...e)));p(this,"setLayout",e=>h(this,we,e));p(this,"getLayout",()=>o(this,we));p(this,"setRenderer",e=>{h(this,ce,e)});p(this,"header",(e,t,s)=>{this.finalized&&h(this,T,new Response(o(this,T).body,o(this,T)));const a=o(this,T)?o(this,T).headers:o(this,J)??h(this,J,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});p(this,"status",e=>{h(this,de,e)});p(this,"set",(e,t)=>{o(this,z)??h(this,z,new Map),o(this,z).set(e,t)});p(this,"get",e=>o(this,z)?o(this,z).get(e):void 0);p(this,"newResponse",(...e)=>u(this,G,oe).call(this,...e));p(this,"body",(e,t,s)=>u(this,G,oe).call(this,e,t,s));p(this,"text",(e,t,s)=>!o(this,J)&&!o(this,de)&&!t&&!s&&!this.finalized?new Response(e):u(this,G,oe).call(this,e,t,He(zt,s)));p(this,"json",(e,t,s)=>u(this,G,oe).call(this,JSON.stringify(e),t,He("application/json",s)));p(this,"html",(e,t,s)=>{const a=r=>u(this,G,oe).call(this,r,t,He("text/html; charset=UTF-8",s));return typeof e=="object"?lt(e,Nt.Stringify,!1,{}).then(a):a(e)});p(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});p(this,"notFound",()=>(o(this,ge)??h(this,ge,()=>new Response),o(this,ge).call(this,this)));h(this,ve,e),t&&(h(this,H,t.executionCtx),this.env=t.env,h(this,ge,t.notFoundHandler),h(this,Se,t.path),h(this,ke,t.matchResult))}get req(){return o(this,ye)??h(this,ye,new rt(o(this,ve),o(this,Se),o(this,ke))),o(this,ye)}get event(){if(o(this,H)&&"respondWith"in o(this,H))return o(this,H);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,H))return o(this,H);throw Error("This context has no ExecutionContext")}get res(){return o(this,T)||h(this,T,new Response(null,{headers:o(this,J)??h(this,J,new Headers)}))}set res(e){if(o(this,T)&&e){e=new Response(e.body,e);for(const[t,s]of o(this,T).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=o(this,T).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of a)e.headers.append("set-cookie",r)}else e.headers.set(t,s)}h(this,T,e),this.finalized=!0}get var(){return o(this,z)?Object.fromEntries(o(this,z)):{}}},ve=new WeakMap,ye=new WeakMap,z=new WeakMap,de=new WeakMap,H=new WeakMap,T=new WeakMap,we=new WeakMap,ce=new WeakMap,ge=new WeakMap,J=new WeakMap,ke=new WeakMap,Se=new WeakMap,G=new WeakSet,oe=function(e,t,s){const a=o(this,T)?new Headers(o(this,T).headers):o(this,J)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[l,c]of i)l.toLowerCase()==="set-cookie"?a.append(l,c):a.set(l,c)}if(s)for(const[i,l]of Object.entries(s))if(typeof l=="string")a.set(i,l);else{a.delete(i);for(const c of l)a.append(i,c)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,de);return new Response(e,{status:r,headers:a})},$e),w="ALL",Lt="all",Bt=["get","post","put","delete","options","patch"],nt="Can not add a route since the matcher is already built.",dt=class extends Error{},Ot="__COMPOSED_HANDLER",Ft=e=>e.text("404 Not Found",404),Ge=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},I,k,ct,E,K,Te,De,xe,Wt=(xe=class{constructor(t={}){m(this,k);p(this,"get");p(this,"post");p(this,"put");p(this,"delete");p(this,"options");p(this,"patch");p(this,"all");p(this,"on");p(this,"use");p(this,"router");p(this,"getPath");p(this,"_basePath","/");m(this,I,"/");p(this,"routes",[]);m(this,E,Ft);p(this,"errorHandler",Ge);p(this,"onError",t=>(this.errorHandler=t,this));p(this,"notFound",t=>(h(this,E,t),this));p(this,"fetch",(t,...s)=>u(this,k,De).call(this,t,s[1],s[0],t.method));p(this,"request",(t,s,a,r)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ie("/",t)}`,s),a,r)));p(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(u(this,k,De).call(this,t.request,t,void 0,t.request.method))})});[...Bt,Lt].forEach(i=>{this[i]=(l,...c)=>(typeof l=="string"?h(this,I,l):u(this,k,K).call(this,i,o(this,I),l),c.forEach(n=>{u(this,k,K).call(this,i,o(this,I),n)}),this)}),this.on=(i,l,...c)=>{for(const n of[l].flat()){h(this,I,n);for(const d of[i].flat())c.map(g=>{u(this,k,K).call(this,d.toUpperCase(),o(this,I),g)})}return this},this.use=(i,...l)=>(typeof i=="string"?h(this,I,i):(h(this,I,"*"),l.unshift(i)),l.forEach(c=>{u(this,k,K).call(this,w,o(this,I),c)}),this);const{strict:a,...r}=t;Object.assign(this,r),this.getPath=a??!0?t.getPath??et:Et}route(t,s){const a=this.basePath(t);return s.routes.map(r=>{var l;let i;s.errorHandler===Ge?i=r.handler:(i=async(c,n)=>(await qe([],s.errorHandler)(c,()=>r.handler(c,n))).res,i[Ot]=r.handler),u(l=a,k,K).call(l,r.method,r.path,i)}),this}basePath(t){const s=u(this,k,ct).call(this);return s._basePath=ie(this._basePath,t),s}mount(t,s,a){let r,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?r=n=>n:r=a.replaceRequest));const l=i?n=>{const d=i(n);return Array.isArray(d)?d:[d]}:n=>{let d;try{d=n.executionCtx}catch{}return[n.env,d]};r||(r=(()=>{const n=ie(this._basePath,t),d=n==="/"?0:n.length;return g=>{const x=new URL(g.url);return x.pathname=x.pathname.slice(d)||"/",new Request(x,g)}})());const c=async(n,d)=>{const g=await s(r(n.req.raw),...l(n));if(g)return g;await d()};return u(this,k,K).call(this,w,ie(t,"*"),c),this}},I=new WeakMap,k=new WeakSet,ct=function(){const t=new xe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,h(t,E,o(this,E)),t.routes=this.routes,t},E=new WeakMap,K=function(t,s,a){t=t.toUpperCase(),s=ie(this._basePath,s);const r={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,r]),this.routes.push(r)},Te=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},De=function(t,s,a,r){if(r==="HEAD")return(async()=>new Response(null,await u(this,k,De).call(this,t,s,a,"GET")))();const i=this.getPath(t,{env:a}),l=this.router.match(r,i),c=new Ht(t,{path:i,matchResult:l,env:a,executionCtx:s,notFoundHandler:o(this,E)});if(l[0].length===1){let d;try{d=l[0][0][0][0](c,async()=>{c.res=await o(this,E).call(this,c)})}catch(g){return u(this,k,Te).call(this,g,c)}return d instanceof Promise?d.then(g=>g||(c.finalized?c.res:o(this,E).call(this,c))).catch(g=>u(this,k,Te).call(this,g,c)):d??o(this,E).call(this,c)}const n=qe(l[0],this.errorHandler,o(this,E));return(async()=>{try{const d=await n(c);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return u(this,k,Te).call(this,d,c)}})()},xe),gt=[];function qt(e,t){const s=this.buildAllMatchers(),a=((r,i)=>{const l=s[r]||s[w],c=l[2][i];if(c)return c;const n=i.match(l[0]);if(!n)return[[],gt];const d=n.indexOf("",1);return[l[1][d],n]});return this.match=a,a(e,t)}var Ie="[^/]+",ue=".*",fe="(?:|/.*)",le=Symbol(),Ut=new Set(".\\+*[^]$()");function Gt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ue||e===fe?1:t===ue||t===fe?-1:e===Ie?1:t===Ie?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var X,ee,P,ae,Yt=(ae=class{constructor(){m(this,X);m(this,ee);m(this,P,Object.create(null))}insert(t,s,a,r,i){if(t.length===0){if(o(this,X)!==void 0)throw le;if(i)return;h(this,X,s);return}const[l,...c]=t,n=l==="*"?c.length===0?["","",ue]:["","",Ie]:l==="/*"?["","",fe]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(n){const g=n[1];let x=n[2]||Ie;if(g&&n[2]&&(x===".*"||(x=x.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(x))))throw le;if(d=o(this,P)[x],!d){if(Object.keys(o(this,P)).some(b=>b!==ue&&b!==fe))throw le;if(i)return;d=o(this,P)[x]=new ae,g!==""&&h(d,ee,r.varIndex++)}!i&&g!==""&&a.push([g,o(d,ee)])}else if(d=o(this,P)[l],!d){if(Object.keys(o(this,P)).some(g=>g.length>1&&g!==ue&&g!==fe))throw le;if(i)return;d=o(this,P)[l]=new ae}d.insert(c,s,a,r,i)}buildRegExpStr(){const s=Object.keys(o(this,P)).sort(Gt).map(a=>{const r=o(this,P)[a];return(typeof o(r,ee)=="number"?`(${a})@${o(r,ee)}`:Ut.has(a)?`\\${a}`:a)+r.buildRegExpStr()});return typeof o(this,X)=="number"&&s.unshift(`#${o(this,X)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},X=new WeakMap,ee=new WeakMap,P=new WeakMap,ae),Ee,Ce,Ze,Vt=(Ze=class{constructor(){m(this,Ee,{varIndex:0});m(this,Ce,new Yt)}insert(e,t,s){const a=[],r=[];for(let l=0;;){let c=!1;if(e=e.replace(/\{[^}]+\}/g,n=>{const d=`@\\${l}`;return r[l]=[d,n],l++,c=!0,d}),!c)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=r.length-1;l>=0;l--){const[c]=r[l];for(let n=i.length-1;n>=0;n--)if(i[n].indexOf(c)!==-1){i[n]=i[n].replace(c,r[l][1]);break}}return o(this,Ce).insert(i,t,a,o(this,Ee),s),a}buildRegExp(){let e=o(this,Ce).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,i,l)=>i!==void 0?(s[++t]=Number(i),"$()"):(l!==void 0&&(a[Number(l)]=++t),"")),[new RegExp(`^${e}`),s,a]}},Ee=new WeakMap,Ce=new WeakMap,Ze),$t=[/^$/,[],Object.create(null)],Me=Object.create(null);function xt(e){return Me[e]??(Me[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Zt(){Me=Object.create(null)}function Kt(e){var d;const t=new Vt,s=[];if(e.length===0)return $t;const a=e.map(g=>[!/\*|\/:/.test(g[0]),...g]).sort(([g,x],[b,y])=>g?1:b?-1:x.length-y.length),r=Object.create(null);for(let g=0,x=-1,b=a.length;g<b;g++){const[y,D,F]=a[g];y?r[D]=[F.map(([j])=>[j,Object.create(null)]),gt]:x++;let v;try{v=t.insert(D,x,y)}catch(j){throw j===le?new dt(D):j}y||(s[x]=F.map(([j,W])=>{const Ae=Object.create(null);for(W-=1;W>=0;W--){const[_e,R]=v[W];Ae[_e]=R}return[j,Ae]}))}const[i,l,c]=t.buildRegExp();for(let g=0,x=s.length;g<x;g++)for(let b=0,y=s[g].length;b<y;b++){const D=(d=s[g][b])==null?void 0:d[1];if(!D)continue;const F=Object.keys(D);for(let v=0,j=F.length;v<j;v++)D[F[v]]=c[D[F[v]]]}const n=[];for(const g in l)n[g]=s[l[g]];return[i,n,r]}function re(e,t){if(e){for(const s of Object.keys(e).sort((a,r)=>r.length-a.length))if(xt(s).test(t))return[...e[s]]}}var Y,V,Pe,ht,Ke,Qt=(Ke=class{constructor(){m(this,Pe);p(this,"name","RegExpRouter");m(this,Y);m(this,V);p(this,"match",qt);h(this,Y,{[w]:Object.create(null)}),h(this,V,{[w]:Object.create(null)})}add(e,t,s){var c;const a=o(this,Y),r=o(this,V);if(!a||!r)throw new Error(nt);a[e]||[a,r].forEach(n=>{n[e]=Object.create(null),Object.keys(n[w]).forEach(d=>{n[e][d]=[...n[w][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const n=xt(t);e===w?Object.keys(a).forEach(d=>{var g;(g=a[d])[t]||(g[t]=re(a[d],t)||re(a[w],t)||[])}):(c=a[e])[t]||(c[t]=re(a[e],t)||re(a[w],t)||[]),Object.keys(a).forEach(d=>{(e===w||e===d)&&Object.keys(a[d]).forEach(g=>{n.test(g)&&a[d][g].push([s,i])})}),Object.keys(r).forEach(d=>{(e===w||e===d)&&Object.keys(r[d]).forEach(g=>n.test(g)&&r[d][g].push([s,i]))});return}const l=tt(t)||[t];for(let n=0,d=l.length;n<d;n++){const g=l[n];Object.keys(r).forEach(x=>{var b;(e===w||e===x)&&((b=r[x])[g]||(b[g]=[...re(a[x],g)||re(a[w],g)||[]]),r[x][g].push([s,i-d+n+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(o(this,V)).concat(Object.keys(o(this,Y))).forEach(t=>{e[t]||(e[t]=u(this,Pe,ht).call(this,t))}),h(this,Y,h(this,V,void 0)),Zt(),e}},Y=new WeakMap,V=new WeakMap,Pe=new WeakSet,ht=function(e){const t=[];let s=e===w;return[o(this,Y),o(this,V)].forEach(a=>{const r=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];r.length!==0?(s||(s=!0),t.push(...r)):e!==w&&t.push(...Object.keys(a[w]).map(i=>[i,a[w][i]]))}),s?Kt(t):null},Ke),$,L,Qe,Jt=(Qe=class{constructor(e){p(this,"name","SmartRouter");m(this,$,[]);m(this,L,[]);h(this,$,e.routers)}add(e,t,s){if(!o(this,L))throw new Error(nt);o(this,L).push([e,t,s])}match(e,t){if(!o(this,L))throw new Error("Fatal error");const s=o(this,$),a=o(this,L),r=s.length;let i=0,l;for(;i<r;i++){const c=s[i];try{for(let n=0,d=a.length;n<d;n++)c.add(...a[n]);l=c.match(e,t)}catch(n){if(n instanceof dt)continue;throw n}this.match=c.match.bind(c),h(this,$,[c]),h(this,L,void 0);break}if(i===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(o(this,L)||o(this,$).length!==1)throw new Error("No active router has been determined yet.");return o(this,$)[0]}},$=new WeakMap,L=new WeakMap,Qe),be=Object.create(null),Z,_,te,he,C,B,Q,pe,Xt=(pe=class{constructor(t,s,a){m(this,B);m(this,Z);m(this,_);m(this,te);m(this,he,0);m(this,C,be);if(h(this,_,a||Object.create(null)),h(this,Z,[]),t&&s){const r=Object.create(null);r[t]={handler:s,possibleKeys:[],score:0},h(this,Z,[r])}h(this,te,[])}insert(t,s,a){h(this,he,++We(this,he)._);let r=this;const i=jt(s),l=[];for(let c=0,n=i.length;c<n;c++){const d=i[c],g=i[c+1],x=Mt(d,g),b=Array.isArray(x)?x[0]:d;if(b in o(r,_)){r=o(r,_)[b],x&&l.push(x[1]);continue}o(r,_)[b]=new pe,x&&(o(r,te).push(x),l.push(x[1])),r=o(r,_)[b]}return o(r,Z).push({[t]:{handler:a,possibleKeys:l.filter((c,n,d)=>d.indexOf(c)===n),score:o(this,he)}}),r}search(t,s){var n;const a=[];h(this,C,be);let i=[this];const l=Xe(s),c=[];for(let d=0,g=l.length;d<g;d++){const x=l[d],b=d===g-1,y=[];for(let D=0,F=i.length;D<F;D++){const v=i[D],j=o(v,_)[x];j&&(h(j,C,o(v,C)),b?(o(j,_)["*"]&&a.push(...u(this,B,Q).call(this,o(j,_)["*"],t,o(v,C))),a.push(...u(this,B,Q).call(this,j,t,o(v,C)))):y.push(j));for(let W=0,Ae=o(v,te).length;W<Ae;W++){const _e=o(v,te)[W],R=o(v,C)===be?{}:{...o(v,C)};if(_e==="*"){const q=o(v,_)["*"];q&&(a.push(...u(this,B,Q).call(this,q,t,o(v,C))),h(q,C,R),y.push(q));continue}const[ut,Oe,me]=_e;if(!x&&!(me instanceof RegExp))continue;const N=o(v,_)[ut],ft=l.slice(d).join("/");if(me instanceof RegExp){const q=me.exec(ft);if(q){if(R[Oe]=q[0],a.push(...u(this,B,Q).call(this,N,t,o(v,C),R)),Object.keys(o(N,_)).length){h(N,C,R);const Re=((n=q[0].match(/\//))==null?void 0:n.length)??0;(c[Re]||(c[Re]=[])).push(N)}continue}}(me===!0||me.test(x))&&(R[Oe]=x,b?(a.push(...u(this,B,Q).call(this,N,t,R,o(v,C))),o(N,_)["*"]&&a.push(...u(this,B,Q).call(this,o(N,_)["*"],t,R,o(v,C)))):(h(N,C,R),y.push(N)))}}i=y.concat(c.shift()??[])}return a.length>1&&a.sort((d,g)=>d.score-g.score),[a.map(({handler:d,params:g})=>[d,g])]}},Z=new WeakMap,_=new WeakMap,te=new WeakMap,he=new WeakMap,C=new WeakMap,B=new WeakSet,Q=function(t,s,a,r){const i=[];for(let l=0,c=o(t,Z).length;l<c;l++){const n=o(t,Z)[l],d=n[s]||n[w],g={};if(d!==void 0&&(d.params=Object.create(null),i.push(d),a!==be||r&&r!==be))for(let x=0,b=d.possibleKeys.length;x<b;x++){const y=d.possibleKeys[x],D=g[d.score];d.params[y]=r!=null&&r[y]&&!D?r[y]:a[y]??(r==null?void 0:r[y]),g[d.score]=!0}}return i},pe),se,Je,es=(Je=class{constructor(){p(this,"name","TrieRouter");m(this,se);h(this,se,new Xt)}add(e,t,s){const a=tt(t);if(a){for(let r=0,i=a.length;r<i;r++)o(this,se).insert(e,a[r],s);return}o(this,se).insert(e,t,s)}match(e,t){return o(this,se).search(e,t)}},se=new WeakMap,Je),pt=class extends Wt{constructor(e={}){super(e),this.router=e.router??new Jt({routers:[new Qt,new es]})}},ts=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(i=>typeof i=="string"?i==="*"?()=>i:l=>i===l?l:null:typeof i=="function"?i:l=>i.includes(l)?l:null)(s.origin),r=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(l,c){var g;function n(x,b){l.res.headers.set(x,b)}const d=await a(l.req.header("origin")||"",l);if(d&&n("Access-Control-Allow-Origin",d),s.credentials&&n("Access-Control-Allow-Credentials","true"),(g=s.exposeHeaders)!=null&&g.length&&n("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),l.req.method==="OPTIONS"){s.origin!=="*"&&n("Vary","Origin"),s.maxAge!=null&&n("Access-Control-Max-Age",s.maxAge.toString());const x=await r(l.req.header("origin")||"",l);x.length&&n("Access-Control-Allow-Methods",x.join(","));let b=s.allowHeaders;if(!(b!=null&&b.length)){const y=l.req.header("Access-Control-Request-Headers");y&&(b=y.split(/\s*,\s*/))}return b!=null&&b.length&&(n("Access-Control-Allow-Headers",b.join(",")),l.res.headers.append("Vary","Access-Control-Request-Headers")),l.res.headers.delete("Content-Length"),l.res.headers.delete("Content-Type"),new Response(null,{headers:l.res.headers,status:204,statusText:"No Content"})}await c(),s.origin!=="*"&&l.header("Vary","Origin",{append:!0})}};const A=(e,t,s,a)=>`
  ...
  `,f=new pt;f.get("/health",e=>e.text("Hono is running!"));f.get("/api/test",e=>e.json({status:"ok",runtime:"edge"}));f.use("/api/*",ts());f.post("/api/admission-inquiry",async e=>{const t=await e.req.json();return console.log("Admission Inquiry:",t),e.json({success:!0,message:"Thank you! Our admissions team will contact you within 24 hours."})});f.get("/",e=>e.html(S(ss(),"Home","home")));f.get("/courses/cardiac-technology",e=>e.html(S(as(),"B.Sc. Cardiac Technology","courses-cardiac")));f.get("/courses/physician-assistant",e=>e.html(S(rs(),"B.Sc. Physician Assistant","courses-physician")));f.get("/courses/radiography",e=>e.html(S(is(),"B.Sc. Radiography & Imaging Technology","courses-radiography")));f.get("/courses/operation-theatre",e=>{const t=`
    ...
    `;return e.html(S(t,"B.Sc. Operation Theatre & Anesthesia Technology","courses-operation-theatre"))});f.get("/facilities",e=>e.html(S(os(),"Facilities","facilities")));f.get("/innovation",e=>e.html(S(ls(),"Innovation Hub","innovation")));f.get("/about",e=>e.html(S(ns(),"About Us","about")));f.get("/contact",e=>e.html(S(ds(),"Contact Us","contact")));f.get("/mandatory-disclosure",e=>e.html(S(gs(),"Mandatory Disclosure","mandatory-disclosure")));f.get("/admissions",e=>e.html(S(cs(),"Admissions","admissions")));f.get("/gallery",e=>e.html(S(xs(),"Campus Gallery","gallery")));f.get("/sports-clubs",e=>e.html(S(hs(),"Sports & Clubs","sports-clubs")));f.get("/brochure",e=>e.html(S(ps(),"Digital Brochure","brochure")));f.get("/transport",e=>e.html(S(ms(),"Transport Services","transport")));f.get("/events",e=>e.html(S(bs(),"Events & Celebrations","events")));f.get("/success-stories",e=>e.html(S(us(),"Success Stories","success-stories")));f.get("/stanford-pathway",e=>e.html(S(fs(),"Pathway to Stanford","stanford-pathway")));const Ye=new pt,vs=Object.assign({"/src/index.tsx":f});let bt=!1;for(const[,e]of Object.entries(vs))e&&(Ye.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Ye.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),bt=!0);if(!bt)throw new Error("Can't import modules from ['/src/index.tsx']");export{Ye as default};
